...
{
    // константы публичные, но начиная с версии php 7.1 константам можно задавать модификатор доступа.
    ...
    const LOCATION_ERROR = 'Выбранная зона недоступна по Вашему абонементу';
    const EXPIRED_ERROR = 'Срок действия абонемента закончился';
    const TIME_ERROR = 'Данное время недоступно по Вашему абонементу';
